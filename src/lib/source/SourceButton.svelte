...
<button onclick={toggleSourceView} id={uniqueId} type="button" class={btnCls}>
    ...
    >
        <path
            ...
            stroke-width="2"
            d="M8 9l3 3-3 3m5 0h3M4 19h16a1 1 0 0 0 1-1V6a1 1 0 0 0-1-1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1z"
        ></path>
    </svg>
    ...
    <Modal title="Edit HTML Source" bind:open={showModal} autoclose={false} size="md">
        <div class="space-y-4">
            <div class="relative">
                ...
                {#if sourceError}
                    <div
                        class="mt-2 rounded bg-red-50 p-2 text-sm text-red-600 dark:bg-red-900/20 dark:text-red-400"
                    >
                        {sourceError}
                    </div>
                {/if}
