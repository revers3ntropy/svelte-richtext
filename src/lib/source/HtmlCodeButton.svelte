...
<button onclick={handleClick} id={uniqueId} type="button" class={btnCls}>
    ...
    >
        <path
            d="M8.5 6L6 8.5 8.5 11l1.4-1.4L8.2 8.5l1.7-1.1L8.5 6zm7 0l-1.4 1.5L15.8 8.5l-1.7 1.1L15.5 11L18 8.5 15.5 6z"
        ></path>
    ...
    <Modal title="Insert HTML Code Block" bind:open={showModal} autoclose={false} size="md">
        <div class="space-y-4">
            ...
            <div class="text-sm text-gray-600 dark:text-gray-400">
                ...
                <pre class="mt-2 overflow-x-auto rounded bg-gray-100 p-2 text-xs dark:bg-gray-800"
                    ><code class="language-html">{escapeHtml(htmlInput)}</code></pre
                >
            </div>
        </div>
