...
>
    <div class="bubble-menu">
        ...
        {#if showItalic}
            <button
                onclick={() => runFormatCommand(editor, 'italic')}
        ...
        {#if showStrike}
            <button
                onclick={() => runFormatCommand(editor, 'strike')}
        ...
        {#if showUnderline}
            <button
                onclick={() => runFormatCommand(editor, 'underline')}
        ...
        {#if showHighlight}
            <button
                onclick={() => runFormatCommand(editor, 'highlight')}
